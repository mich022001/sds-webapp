          ...
          <div className="text-white">
            ...
            <div className="mb-12 flex flex-col gap-4 sm:flex-row">
              <button
                ...
                className="rounded-full bg-yellow-400 px-8 py-4 text-base font-bold text-gray-900 shadow-lg transition hover:bg-yellow-300"
              >
                Become a Member
              </button>
              ...
              <button
                ...
                className="rounded-full border-2 border-white/40 px-8 py-4 text-base font-semibold text-white transition hover:border-white hover:bg-white/10"
              >
                View Products →
              </button>
            </div>
